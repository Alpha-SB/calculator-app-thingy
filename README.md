...
Simple console calculator that handles decimal numbers. Start with an initial value, chain additions, subtractions, multiplications, divisions, or modulo operations, jump to a fresh calculation with `n`, and quit anytime with `q`.
